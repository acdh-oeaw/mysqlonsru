<?php
/**
 * This file script provides SRU access to a mysql database containing TEI data
 * language profiles.
 * 
 * 
 * @uses $dbConfigfile
...
error_reporting(E_ALL);
 ...
 //TODO: actually create that $responseTemplateFcs file ...
...
/**
 * Return the explain template with the host id filled in
 * 
 ...
 */
 ...
 /**
  * Function implementing searchRetrieve
  * 
  * @uses $responseTemplate
  * @uses $responseTemplateFcs
  * @uses $version
